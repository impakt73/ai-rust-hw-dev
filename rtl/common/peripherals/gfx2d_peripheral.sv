...
module gfx2d_peripheral #(
    ...
    localparam logic [15:0] REG_FRAME_COUNTER = 16'h000C;
                ...
                if (periph_reg_access) begin
                    if (periph_mem_a_we) begin
                        case (periph_addr_offset)
                            ...
                            REG_CONTROL: video_scanout_hold_reg <= periph_mem_a_wdata[0];
                            default: begin
                            end
                        endcase
                    end else begin
                        case (periph_addr_offset)
                            ...
                            REG_CONTROL: response_data <= {31'h0, video_scanout_hold_reg};
                            REG_FRAME_COUNTER: response_data <= frame_counter_reg;
