...
It is structured similarly to `rtl/fpga/led_demo`, but uses the newer root FPGA flow (`rtl/fpga/Makefile` and `rtl/fpga/ice40_alchitry_cu/ice40_alchitry_cu.pcf`) as the baseline.
