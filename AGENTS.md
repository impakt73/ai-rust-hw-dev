...
- Until the repo-wide reset migration is complete, some legacy modules may still expose active-low reset interfaces. Preserve those interfaces unless the task explicitly includes migrating that boundary.
