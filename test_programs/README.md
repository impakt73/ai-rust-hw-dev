...
cargo build --release --target riscv32imafc-unknown-none-elf --bin <program_name>
cp target/riscv32imafc-unknown-none-elf/release/<program_name> ../test_programs/<program_name>.elf
```
