...
mod tests {
    ...
    /// Type alias for the simulator with default callback types
    type DefaultSimulator = Simulator<'static, fn(u32), fn(&riscv_core::trace::InstructionTrace)>;
    ...
    /// 4. Returning results for verification
    fn run_program(
        instructions: &[u32],
        max_cycles: u64,
    ) -> Result<(SimulationResult, DefaultSimulator), String> {
