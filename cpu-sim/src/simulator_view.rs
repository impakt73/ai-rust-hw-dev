...
impl<'a> SimulatorView<'a> {
    ...
    /// // write_memory_region is typically used within the run-to-completion callback helper setup_callback
    /// let instructions = vec![0x13, 0x01, 0x00, 0x00]; // addi x2, x0, 0
    /// let result = run_with_callbacks(
    ///     100,
    ...
    /// # use cpu_sim::*;
    /// # fn main() -> Result<(), String> {
    /// // dump_memory_region is typically used in the run-to-completion callback helper termination_callback
    /// run_with_callbacks(
    ///     100,
    ///     false, // print_inst_trace
    ///     false, // print_fsm_state
    ...
    /// # use cpu_sim::*;
    /// # fn main() -> Result<(), String> {
    /// // dump_memory_region_as_image is typically used in the run-to-completion callback helper termination_callback
    /// run_with_callbacks(
    ///     100,
    ///     false, // print_inst_trace
    ///     false, // print_fsm_state
