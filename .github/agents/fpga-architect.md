...
*   **High-Frequency First:** High-frequency operation is a repo priority. Prefer registered signals, shorter combinational cones, and multi-cycle staging to maximize Fmax.
